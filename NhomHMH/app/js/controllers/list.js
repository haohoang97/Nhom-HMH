...
(function(){
    ...
    function ListController(quizMetrics, DataService){
        ...
        vm.data = DataService.myTestData; // Controller reference to the turtle info created in the factory
        vm.activeMyTest = {}; // will be used in the view to hold the data of currently active turtle
        vm.changeActiveMyTest = changeActiveMyTest; // reference to a named function below
